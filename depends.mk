...
build/hw/intermediate/DataHazardUnit.bo: src/DataHazardUnit.bsv
build/hw/intermediate/Cache.bo: src/Cache.bsv
build/hw/intermediate/MemoryController.bo: src/MemoryController.bsv
build/hw/intermediate/Stage1.bo: src/Stage1.bsv
build/hw/intermediate/Stage2.bo: src/Stage2.bsv
build/hw/intermediate/Stage3.bo: src/Stage3.bsv
build/hw/intermediate/Stage4.bo: src/Stage4.bsv
build/hw/intermediate/Stage5.bo: src/Stage5.bsv
